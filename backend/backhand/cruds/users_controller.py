...
def register_routes(bp, socketio, users_service):
    ...
    def get_all():
        if request.method=='GET':
            return users_service.get_all_dict()
    ...
    def get_page():
        if request.method=='POST':
            try:
                ...
                page, actual_index, max_page_size=users_service.get_filter_page(page_index, page_size, name_key, strength_key, sort_by_name)
    ...
    def remove_user(id):
        try:
            users_service.user_remove(int(id))
        except Exception as e:
            pass
        return 404
    ...
    def get_all_users():
        try:
            ...
            users = users_service.get_all_users(page, per_page)
    ...
    def user_update():
        ...
        # if True:
            ...
            users_service.user_update(id, None, user_type, None, None)
            emit_users_refresh()
            return {}, 200
            return "User is not an admin", 400
        except Exception as e:
